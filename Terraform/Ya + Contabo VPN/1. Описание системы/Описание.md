### **Идея**
Использование собственного VPN-сервера на VPS как компромисс между технической эффективностью и юридической безопасностью. Использование Terraform для автоматизации разворачивания инфраструктуры между Contabo и Yandex Cloud.
